export default {
    ...
    'com.alipay.test.TestObj': {
        ...
        list1: {
            type: 'java.util.List',
            generic: [{ isEnum: true, type: 'com.alipay.test.TestEnum' }],
        },
        list2: {
            type: 'java.util.List',
            generic: [{ type: 'java.lang.Integer' }],
        },
        list3: {
            type: 'java.util.List',
            generic: [{ type: 'com.alipay.test.sub.TestObj2' }],
        },
        list4: {
            type: 'java.util.List',
        ...
        list5: {
            type: 'java.util.List',
            generic: [{ isArray: true, type: 'byte' }],
        },
        map1: {
            type: 'java.util.Map',
            generic: [
