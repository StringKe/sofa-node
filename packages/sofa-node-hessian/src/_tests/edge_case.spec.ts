import * as hessian from 'hessian.js-1'

import { encode } from '../index'
import { default as classMap } from './fixtures/edge_class_map'
    ...
    versions.forEach((version) => {
        ...
        it('should validate enum name', () => {
            ...
            try {
                ...
                assert(
                    error?.message ===
                        'enum: com.test.model.datum.DatumStaus have no name: PRERELEASING_INVALIDATE',
                )
            }
        })
        ...
        it('should support getter defaultValue', async () => {
            ...
            const resUndefined = hessian.decode(
                encode(objUndefined, version, classMap),
                version,
            )
